...
export default function About() {
  ...
  const techs = [
    ...
    {
      icon: <FaPhp className="text-indigo-600 w-12 h-12" />,
      name: "PHP (LAMP)",
    },
    { icon: <SiLinux className="text-black w-12 h-12" />, name: "Linux" },
    {
      icon: <FaGithub className="text-gray-800 dark:text-white w-12 h-12" />,
      name: "GitHub",
    },
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:space-x-16">
        ...
        >
          <motion.div
            variants={fadeUp}
            className="bg-white dark:bg-[#0C969C] rounded-xl shadow-xl p-6"
          >
            ...
            <p className="text-gray-700 dark:text-[#C8E6E6] text-lg leading-relaxed">
              I’m an{" "}
              <span className="font-bold">aspiring Software Engineer</span> with
              a strong curiosity for how things work and an eagerness to keep
              learning every day. I enjoy exploring new technologies, solving
              problems, and turning ideas into real projects that people can
              actually use. While I’m still growing in the field, I’m always
              excited to challenge myself, pick up new skills, and collaborate
              with others who share the same passion for tech. For me, every
              step is an opportunity to improve and get closer to becoming the
              kind of developer who builds meaningful and impactful software.
            </p>
          </motion.div>

          <motion.div
            variants={fadeUp}
            className="bg-white dark:bg-[#274D60] rounded-xl shadow-xl p-6"
          >
            <h3 className="text-3xl font-semibold mb-4 border-l-4 border-yellow-500 pl-4">
              Professional Skills
            </h3>
          ...
          <motion.div
            variants={fadeUp}
            className="bg-white dark:bg-[#145B5E] rounded-xl shadow-xl p-6"
          >
            <h3 className="text-3xl font-semibold mb-4 border-l-4 border-yellow-500 pl-4">
              Quick Facts
            </h3>
            <ul className="text-gray-700 dark:text-[#E0F7FA] space-y-2 text-lg">
              ...
              <li>
                <span className="font-bold">Languages:</span> English, Filipino
              </li>
              <li>
                <span className="font-bold">Location:</span> Philippines
              </li>
              <li>
                <span className="font-bold">Mindset:</span> Lifelong learner,
          ...
          <motion.div
            variants={fadeUp}
            className="bg-white dark:bg-[#032F30] rounded-xl shadow-xl p-6"
          >
            <h3 className="text-3xl font-semibold mb-4 border-l-4 border-yellow-500 pl-4">
              Hobbies & Interests
            </h3>
            <p className="text-gray-700 dark:text-[#C8E6E6] text-lg leading-relaxed">
              In my free time, I enjoy playing problem-solving games,
              programming side projects, and exploring new tech stacks. I’m also
              deeply curious about learning — whether it’s tech innovations,
              design tools, or personal growth.
            </p>
          </motion.div>
        </motion.div>
          ...
          <div className="bg-white dark:bg-[#6BA3BE] rounded-xl shadow-xl p-6">
            ...
            >
              {techs.map((tech, i) => (
                ...
                >
                  {tech.icon}
                  <span className="text-gray-700 dark:text-[#E0F7FA] font-medium">
                    {tech.name}
                  </span>
                </motion.div>
              ))}
