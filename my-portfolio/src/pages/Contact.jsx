...
export default function Contact() {
  return (
    ...
    >
      {/* Section Title */}
      <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center tracking-wide transition-colors duration-700">
        Contact Me
      </h2>
      <p className="text-base md:text-lg mb-8 text-center text-gray-700 dark:text-[#B2DFDB] max-w-xl transition-colors duration-700">
      ...
      {/* Footer */}
      <div className="absolute bottom-4 text-center text-xs md:text-sm text-gray-600 dark:text-[#9BBEC8] transition-colors duration-700">
