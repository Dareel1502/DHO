      ...
      {selectedProject && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white dark:bg-[#032F30] rounded-2xl shadow-2xl p-8 w-11/12 md:w-2/3 lg:w-1/2 relative transition-colors duration-500">
            ...
            <img src={selectedProject.image} alt={selectedProject.title} className="w-full h-72 object-cover rounded-lg mb-6" />
            <p className="text-gray-700 dark:text-[#C8E6E6] text-lg leading-relaxed">{selectedProject.description}</p>
          </div>
        </div>
      )}
    </section>
